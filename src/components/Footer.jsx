    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            {/* brand logo */}
            <div className="flex justify-center text-teal-600 dark:text-teal-300 sm:justify-start h-20">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    ...
                    href="/"
                  >
                    Humanitarian Aid and Relief Services
                  </a>
                </li>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 sm:order-first sm:mt-0">
              &copy; { new Date().getFullYear() } <b>Prestige Foundation</b>  | By Temples-Dev 💕
            </p>
          </div>
        </div>
      </div>
